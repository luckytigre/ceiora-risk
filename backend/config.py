...
NEON_REBUILD_WORKSPACE_RETENTION = max(0, int(os.getenv("NEON_REBUILD_WORKSPACE_RETENTION", "2")))
...
SOURCE_DAILY_WRITE_FUNDAMENTALS = _env_bool("SOURCE_DAILY_WRITE_FUNDAMENTALS", True)
SOURCE_DAILY_WRITE_CLASSIFICATION = _env_bool("SOURCE_DAILY_WRITE_CLASSIFICATION", True)
