  ...
  const data: ChartData<"bar" | "line", number[], string> = {
    ...
    datasets: [
      ...
      },
      {
        ...
        backgroundColor: chartTextColor("secondary", 0.46),
        hoverBackgroundColor: chartTextColor("secondary", 0.58),
        borderWidth: 0,
        borderRadius: 0,
        borderSkipped: false,
        inflateAmount: 0,
      ...
      },
      {
        ...
        backgroundColor: chartTextColor("muted", 0.4),
        hoverBackgroundColor: chartTextColor("muted", 0.5),
        borderWidth: 0,
        borderRadius: 0,
        borderSkipped: false,
        inflateAmount: 0,
