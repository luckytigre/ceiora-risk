  ...
  try {
    ...
    await page.route("**/api/**", async (route) => {
      ...
      if (method === "GET" && pathName === "/api/cpar/ticker/AAPL") {
        return fulfillJson({
          package_run_id: scenario === "detail_mismatch" ? "run_detail_old" : "run_curr",
          package_date: scenario === "detail_mismatch" ? "2026-03-07" : "2026-03-14",
          profile: "cpar-weekly",
          method_version: "cPAR1",
          factor_registry_version: "cPAR1_registry_v1",
          data_authority: "neon",
      ...
      if (method === "GET" && pathName === "/api/cpar/ticker/AAPL/hedge") {
        return fulfillJson({
          package_run_id: scenario === "hedge_mismatch" ? "run_hedge_old" : "run_curr",
          package_date: scenario === "hedge_mismatch" ? "2026-03-07" : "2026-03-14",
          profile: "cpar-weekly",
          method_version: "cPAR1",
          factor_registry_version: "cPAR1_registry_v1",
          data_authority: "neon",
